...
- 🎯 Entry points to execute your program using `python -m <fastapi_app>` or `$ fastapi_app` with basic CLI argument parsing.
...
[![codecov](https://codecov.io/gh/zzhao8053/fastapi-app/branch/main/graph/badge.svg?token=fastapi-app_token_here)](https://codecov.io/gh/zzhao8053/fastapi-app)
[![CI](https://github.com/zzhao8053/fastapi-app/actions/workflows/main.yml/badge.svg)](https://github.com/zzhao8053/fastapi-app/actions/workflows/main.yml)

Awesome fastapi_app created by zzhao8053

## Install

from source
```bash
git clone https://github.com/zzhao8053/fastapi-app fastapi_app
cd fastapi_app
make install
```
...
```bash
$ fastapi_app run --port 8080
```

or

```bash
python -m fastapi_app run --port 8080
```
...
```bash
❯ fastapi_app --help
Usage: fastapi_app [OPTIONS] COMMAND [ARGS]...
...
```bash
❯ fastapi_app create-user --help
Usage: fastapi_app create-user [OPTIONS] USERNAME PASSWORD
...
```bash
fastapi_app create-user admin admin --superuser
```
...
Run with `fastapi_app run` and access http://127.0.0.1:8000/docs

![](https://raw.githubusercontent.com/rochacbruno/fastapi-project-template/master/docs/api.png)


**For some api calls you must authenticate** using the user created with `fastapi_app create-user`.
...
-----------------------------------------------------
fastapi_app/__init__.py              4      0   100%
fastapi_app/app.py                  16      1    94%
fastapi_app/cli.py                  21      0   100%
fastapi_app/config.py                5      0   100%
fastapi_app/db.py                   10      0   100%
fastapi_app/models/__init__.py       0      0   100%
fastapi_app/models/content.py       47      1    98%
fastapi_app/routes/__init__.py      11      0   100%
fastapi_app/routes/content.py       52     25    52%
fastapi_app/routes/security.py      15      1    93%
fastapi_app/routes/user.py          52     26    50%
fastapi_app/security.py            103     12    88%
-----------------------------------------------------
TOTAL                               336     66    80%
...
> `dynaconf_merge` is a boolean that tells if the settings should be merged with the default settings defined in fastapi_app/default.toml.
