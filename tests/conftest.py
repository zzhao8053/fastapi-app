...
# WARNING: Ensure imports from `fastapi_app` comes after this line
from fastapi_app import app, settings, db  # noqa
from fastapi_app.cli import create_user, cli  # noqa
